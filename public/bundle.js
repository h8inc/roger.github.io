...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	var div11, img, t0, h1, t2, label0, t4, div0, t5_value = ctx.wastedHoursProject.toLocaleString('en', ctx.decimalOptions), t5, t6, label1, t8, div1, t9_value = ctx.opportunityCost.toLocaleString('en', ctx.currencyOptions), t9, t10, label2, t12, div2, t13_value = ctx.billableHoursYearly.toLocaleString('en', ctx.integerOptions), t13, t14, label3, t16, div9, div5, div3, t17_value = ctx.revenueIncreaseTeam.toLocaleString('en', ctx.currencyOptions), t17, t18, div4, t19, t20, t21, t22, div8, div6, t23_value = ctx.revenueIncreaseOrg.toLocaleString('en', ctx.currencyOptions), t23, t24, div7, t25, t26, t27, t28, div10, p0, t30, p1, span, t32, a, t33, dispose;
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			if ((changed.wastedHoursProject) && t5_value !== (t5_value = ctx.wastedHoursProject.toLocaleString('en', ctx.decimalOptions))) {
    				set_data(t5, t5_value);
    			}

    			if ((changed.opportunityCost) && t9_value !== (t9_value = ctx.opportunityCost.toLocaleString('en', ctx.currencyOptions))) {
    				set_data(t9, t9_value);
    			}

    			if ((changed.billableHoursYearly) && t13_value !== (t13_value = ctx.billableHoursYearly.toLocaleString('en', ctx.integerOptions))) {
    				set_data(t13, t13_value);
    			}

    			if ((changed.revenueIncreaseTeam) && t17_value !== (t17_value = ctx.revenueIncreaseTeam.toLocaleString('en', ctx.currencyOptions))) {
    				set_data(t17, t17_value);
    			}

    			if ((changed.revenueIncreaseOrg) && t23_value !== (t23_value = ctx.revenueIncreaseOrg.toLocaleString('en', ctx.currencyOptions))) {
    ...
    function create_fragment(ctx) {
    	var div5, div4, img, t0, h1, t2, div2, h20, t4, label0, t6, input0, input0_placeholder_value, t7, label1, t9, div1, input1, input1_placeholder_value, t10, div0, t11, t12, div3, h21, t14, label2, t16, input2, input2_placeholder_value, t17, label3, t19, input3, input3_placeholder_value, t20, label4, t22, input4, input4_placeholder_value, t23, dispose;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let billsProject, timeSendingApprovalsProject, Communication, wastedHoursProject, opportunityCost, billableHoursYearly, revenueIncreaseTeam, revenueIncreaseOrg;

    	$$self.$$.update = ($$dirty = { expense: 1, bills: 1, vendors: 1, feedbackLoops: 1, communicationVendors: 1, billsProject: 1, timeSendingApprovalsProject: 1, Communication: 1, wastedHoursProject: 1, billable: 1, team: 1, billableHoursYearly: 1 }) => {
    		if ($$dirty.expense || $$dirty.bills || $$dirty.vendors) { $$invalidate('billsProject', billsProject = (expense || initial.expense) + (bills || initial.bills) + (vendors || initial.vendors)) ; }
    		if ($$dirty.vendors || $$dirty.feedbackLoops) { $$invalidate('timeSendingApprovalsProject', timeSendingApprovalsProject = ((vendors || initial.vendors) * feedbackLoops)); }
    		if ($$dirty.feedbackLoops || $$dirty.communicationVendors) { $$invalidate('Communication', Communication = (feedbackLoops * (communicationVendors || initial.communicationVendors) + feedbackLoops) / 60); }
    		if ($$dirty.billsProject || $$dirty.timeSendingApprovalsProject || $$dirty.Communication) { $$invalidate('wastedHoursProject', wastedHoursProject = billsProject + timeSendingApprovalsProject + Communication); }
    		...
    		if ($$dirty.billableHoursYearly || $$dirty.billable || $$dirty.team) { $$invalidate('revenueIncreaseTeam', revenueIncreaseTeam = billableHoursYearly * (billable || initial.billable) /12/20/8 * (team || initial.team) - (49 * 12)); }
    		if ($$dirty.billableHoursYearly || $$dirty.billable || $$dirty.team) { $$invalidate('revenueIncreaseOrg', revenueIncreaseOrg = billableHoursYearly * (billable || initial.billable) /12/4/5/8 * (team || initial.team) - (119 * 12)); }
    		if ($$dirty.team || $$dirty.billable || $$dirty.expense || $$dirty.bills || $$dirty.vendors || $$dirty.communicationVendors) { {
                    const data = [
                        Math.abs(team),
                        Math.abs(billable),
                        Math.abs(expense),
